			...
			<div class="md:flex gap-4 justify-between mx-auto w-full">
				...
				<div class="md:w-[60%] bg-white p-3 rounded-lg">
					<div v-if="true">
						...
						<p class="font-light text-[12px] mb-2">Seção da Descrição</p>
					</div>
					...
					<p class="text-[#009A66] text-sm font-semibold pt-1">
						Entrega grátis em 11-dias acima de R$ 29,99
					</p>

					<p class="text-[#009A66] text-sm font-semibold pt-1">Frete Grátis</p>
					...
					>
						<div v-if="isInCart">Está Adicionado</div>
